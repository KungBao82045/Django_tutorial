...
Etter du har gjort det, skriv `python3 manage.py migrate` på terminalen. Bruk kommandoen hvis du endrer eller oppretter ny modell til databasen for å sikre at applikasjonen fungere riktig.
